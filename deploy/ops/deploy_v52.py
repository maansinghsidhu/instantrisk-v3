"""Deploy backend v52 - Fixed transaction handling for reset"""
import boto3
import os
import zipfile
import time
...
ZIP_NAME = 'backend-v52.zip'

print("="*60)
print("DEPLOYING BACKEND v52")
print("- Fixed reset endpoint transaction handling")
print("- Uses async_engine.begin() for fresh connections")
print("="*60)
