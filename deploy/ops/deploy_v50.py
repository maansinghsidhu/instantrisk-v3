"""Deploy backend v50 - Reset endpoint + fixes"""
import boto3
import os
import zipfile
import time
...
ZIP_NAME = 'backend-v51.zip'

print("="*60)
print("DEPLOYING BACKEND v50")
print("- Qdrant port fix: 6334 -> 6333 (HTTP REST API)")
print("- Chat/RAG service error handling")
print("="*60)
...
print("\n4. Waiting for build to complete (~8-10 min)...")
while True:
    time.sleep(15)
...
print(f"   New revision: v{new_revision}")
...
print("\n7. Waiting for deployment (2-3 minutes)...")
...
print("\n" + "="*60)
print("DEPLOYMENT v50 COMPLETE!")
print("="*60)
print("\nNext step: Run database reset:")
